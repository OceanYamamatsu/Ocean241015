...
-- INSERT INTO `Certification` (`ID`, `StudentID`, `CertificationID`, `CertificationName`, `PassingDate`) VALUES(1, '2', 'D-3', '文書処理検定3級', '2015-06-12'),(2, '5', 'D-3', '文書処理検定3級', '2015-06-12'),(3, '6', 'D-3', '文書処理検定3級', '2015-06-12'),(4, '2', 'S-3', '表計算検定3級', '2015-10-16'),(5, '3', 'S-3', '表計算検定3級', '2015-10-16'),(6, '4', 'S-3', '表計算検定3級', '2015-10-16'),(7, '5', 'S-2', '表計算検定2級', '2015-10-16');
...
from Certification where PassingDate = 20151016);
--問３
select name from student 
where id in (select studentid 
